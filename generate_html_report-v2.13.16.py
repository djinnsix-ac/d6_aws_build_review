...
def generate_dynamodb_section(dynamodb_data):
    ...
    if high_risk > 0 or medium_risk > 0 or low_risk > 0:
        ...
        html += '<ul>\n'
        if high_risk > 0:
            html += '<li><strong>HIGH Priority:</strong> Enable encryption at rest for all tables to protect sensitive data</li>\n'
        if medium_risk > 0:
            ...
            html += '<li><strong>MEDIUM Priority:</strong> Consider using customer-managed KMS keys for additional control over encryption</li>\n'
        if low_risk > 0:
