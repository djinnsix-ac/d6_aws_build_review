...
def generate_storage_section(storage_data):
    ...
    html += '<table>\n'
    html += '<thead><tr><th>Bucket Name</th><th>Region</th><th>Versioning</th><th>Encryption</th><th>Public Block</th><th>Logging</th><th>Security Score</th><th>Action</th></tr></thead>\n'
    html += '<tbody>\n'
    ...
    for idx, bucket in enumerate(storage_data['checks']):
        if bucket.get('Status') == 'Error':
            html += f'''<tr>
                ...
                <td colspan="7"><span class="badge badge-danger">Error: {bucket.get("Error", "")}</span></td>
            </tr>\n'''
            continue
