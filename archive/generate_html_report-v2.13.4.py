...
<head>
    ...
    <style>
        * {{
        ...
        .ecs-services-table th:nth-child(1), .ecs-services-table td:nth-child(1) {{ width: 40%; }} /* Service Name */
        ...
        .ecs-services-table th:nth-child(6), .ecs-services-table td:nth-child(6) {{ width: 20%; }} /* Load Balancer */
