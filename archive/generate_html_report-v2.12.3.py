...
def generate_vpc_section(vpc_data, collected_data=None):
    ...
    for vpc_id, checks in vpc_checks.items():
        ...
        html += f'''<h5 style="margin-top: 20px; color: #2c5aa0; font-size: 15px; cursor: pointer; padding: 8px 0;" 
            ...
            <span id="{config_section_id}-icon" style="display: inline-block; width: 20px;">â–¶</span>
            Configuration
        </h5>\n'''
        ...
        if raw_vpc:
            ...
            if vpc_endpoints:
                ...
                html += f'''<h4 style="margin-top: 20px; color: #667eea; font-size: 16px; cursor: pointer; padding: 8px 0; border-bottom: 2px solid #667eea;" 
                    onclick="toggleSection('{endpoints_section_id}')">
                    <span id="{endpoints_section_id}-icon" style="display: inline-block; width: 20px;">â–¶</span>
        ...
        if raw_vpc:
            ...
            if peering_connections:
                ...
                html += f'''<h4 style="margin-top: 20px; color: #667eea; font-size: 16px; cursor: pointer; padding: 8px 0; border-bottom: 2px solid #667eea;" 
                    ...
                    <span id="{peering_section_id}-icon" style="display: inline-block; width: 20px;">â–¶</span>
