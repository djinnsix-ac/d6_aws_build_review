    ...
    for vpc_id, checks in vpc_checks.items():
        ...
        if igw_info:
            ...
            if has_igw and raw_vpc:
                ...
                if igws:
                    igw_ids = ', '.join([f'<span class="code">{igw.get("InternetGatewayId", "")}</span>' for igw in igws])
                    html += f'<tr><td><strong>Internet Gateway</strong></td><td>Yes ({igw_ids})</td></tr>\n'
                else:
        ...
        # Subnet Distribution - Hierarchical view
        if subnet_info:
            html += '<h4 style="margin-top: 20px; color: #2c5aa0; border-bottom: 2px solid #2c5aa0; padding-bottom: 5px;">Subnet Distribution</h4>\n'
            ...
            html += '<div style="padding: 15px; background: #f8f9fa; border-left: 4px solid #2c5aa0; border-radius: 4px; margin: 10px 0;">\n'
        ...
        if route_tables:
            html += '<h4 style="margin-top: 20px; color: #2c5aa0; border-bottom: 2px solid #2c5aa0; padding-bottom: 5px;">Route Tables</h4>\n'
            html += '<table>\n'
            html += '<thead><tr><th>Route Table ID</th><th>Routes</th><th>IGW Route</th><th>NAT Route</th><th>Associations</th></tr></thead>\n'
            html += '<tbody>\n'
            ...
            for rt in route_tables:
                ...
                html += f'''<tr>
                    <td><span class="code">{rt_id}</span></td>
                    <td>{routes}</td>
