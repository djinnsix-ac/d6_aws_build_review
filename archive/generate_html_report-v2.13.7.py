...
<head>
    ...
    <style>
        * {{
        ...
        .ecs-services-table th:nth-child(1), .ecs-services-table td:nth-child(1) {{ width: 28%; }} /* Service Name */
        ...
        .ecs-services-table th:nth-child(6), .ecs-services-table td:nth-child(6) {{ width: 32%; }} /* Load Balancer */
    ...
    if compute_data.get('ecs'):
        ...
        for cluster in compute_data['ecs']:
            ...
            if services and isinstance(services, list):
                ...
                html += '<thead><tr><th>Service Name</th><th>Status</th><th>Desired Tasks</th><th>Running Tasks</th><th>Launch Type</th><th>Load Balancer</th></tr></thead>\n'
                html += '<tbody>\n'
                ...
                for service in services:
                    ...
                    # Get load balancer info if available - check both camelCase and PascalCase
                    lb_info = ''
                    ...
                    if load_balancers and len(load_balancers) > 0:
                        ...
                        if tg_arn:
                            ...
                            lb_info = f'{tg_name}:{container_port}' if container_port else tg_name
                    ...
                    html += f'''<tr>
                        ...
                        <td><span class="code">{lb_info if lb_info else '—'}</span></td>
                    </tr>\n'''
