...
<div class="graph-controls">
    <div class="legend-item">
        <strong>Network Visualization:</strong> <span style="font-size: 0.9em; color: #666;">(Shows SG-to-SG and Internet connections only)</span>
    </div>
    <button onclick="resetGraph()">Reset View</button>
    <button onclick="filterInternetExposed()">Show Internet-Exposed Only</button>
    ...
    function initSecurityGroupGraph() {
        ...
        securityGroupsData.forEach((sg, idx) => {
            const node = {
                ...
                ingressCount: sg.IpPermissions ? sg.IpPermissions.length : 0,
                egressCount: sg.IpPermissionsEgress ? sg.IpPermissionsEgress.length : 0,
