...
Changelog:
- v2.8.0: Made all major sections collapsible to reduce scrolling - click to expand/collapse
...
def wrap_collapsible_section(title: str, content: str, icon: str = "📋") -> str:
    """Wrap section content in collapsible details element"""
...
def generate_vpc_section(vpc_data):
    ...
    return wrap_collapsible_section("VPC Architecture", html, "🌐")
...
def generate_security_groups_section(sg_data):
    ...
    html += '</tbody></table>\n'
    return wrap_collapsible_section("Security Groups", html, "🛡️")
...
def generate_database_section(db_data):
    ...
    return wrap_collapsible_section("Compute Resources", html, "💻")
...
def generate_sagemaker_section(sagemaker_data):
    ...
    return wrap_collapsible_section("Database Resources", html, "🗄️")
...
def generate_iam_section(iam_data):
    ...
    if not checks:
        ...
        return wrap_collapsible_section("Storage (S3)", html, "🪣")
    ...
    return wrap_collapsible_section("Amazon Bedrock Security", html, "🤖")
...
def generate_monitoring_section(monitoring_data):
    ...
    return wrap_collapsible_section("Amazon SageMaker Security", html, "🧠")
...
def generate_cis_benchmark_section(cis_data):
    ...
    html += '</tbody></table>\n'
    return wrap_collapsible_section("CIS AWS Foundations Benchmark", html, "📋")
